...
class VectorStore:
    def __init__(self, persist_directory: str = ".vectordb"):
        ...
        try:
            # Try to connect to the remote ChromaDB server
            ...
            # If connection fails, fall back to local persistent client
            logger.info(f"Could not connect to remote ChromaDB server: {str(e)}. Falling back to local installation.")
